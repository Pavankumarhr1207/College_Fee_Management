...
<h2 class="text-2xl font-bold mb-6 text-center text-gray-800">Add Fee Payment</h2>
<% if (request.getAttribute("error") != null) { %>
<p class="error mb-4"><%= request.getAttribute("error") %></p>
<% } %>
<form action="addFeePayment" method="post" class="space-y-4">
<div>
...
<option value="Not Paid">Not Paid</option> <%-- Added 'Not Paid' status --%>
</select>
</div>
<button type="submit"
